...
================================================== -->
  <meta name="description" content="Mabecarestore Construction - Premier construction company in Bulawayo, Zimbabwe. Specializing in civil and commercial buildings, renovations, and quality construction services. Building homes one dream at a time.">
  <meta name="keywords" content="construction services bulawayo, construction zimbabwe, building contractors, home renovations, commercial construction, civil construction, building services zimbabwe, Mabecarestore Construction">
  ...
  <meta property="og:description" content="Premier construction company in Bulawayo, Zimbabwe. Building homes one dream at a time with quality and integrity.">
...
<section id="main-container" class="main-container">
  <div class="container">
      ...
      <div class="col-md-4">
        <div class="ts-service-box-bg text-center h-100">
          ...
          <div class="ts-service-box-content">
            ...
            <p>2/46 Khongo Block, Mpopoma, Bulawayo</p>
          </div>
        </div>
      </div><!-- Col 1 end -->
      <div class="col-md-4">
    ...
    <div class="google-map">
      <div id="map" class="map" data-latitude="-20.1325066" data-longitude="28.6139126" data-marker="images/marker.png" data-marker-name="Mabecarestore Construction"></div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form id="contact-form" action="send_mail.php" method="post" role="form">
      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-4 col-md-6 footer-widget footer-about">
            ...
            <p>Mabecarestore Construction is a registered Zimbabwean construction company specializing in the design, construction, and renovation of civil and commercial buildings. We combine technical expertise with modern construction techniques to deliver exceptional projects.</p>
